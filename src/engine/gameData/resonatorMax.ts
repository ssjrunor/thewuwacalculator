...
import {
  ...
  getResCntrNc,
  normResRtCnt,
} from '@/engine/gameData/controlOptions'
import {
  getResModeGroups,
  getResStateControls,
  getResStateGroups,
} from '@/domain/gameData/resonatorStateGraph'
import { cmptTrcNodeB } from '@/engine/runtime/traceNodes'
...
export function isResRtMaxed(
  runtime: ResRuntime,
  details: ResDtls | null | undefined,
  preparedMax?: ResRuntime,
): boolean {
  const maxRuntime = preparedMax ?? maxResRt(runtime, details, {
