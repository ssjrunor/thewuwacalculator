/*
  Author: Runor Ewhro
  Description: converts a prepared target-skill optimizer run into the compact
               execution payload used by cpu/gpu search, including packing the
               target context and optionally rebasing combo window settings.
*/
