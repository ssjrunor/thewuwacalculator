...
import { ECHO_OPTIMIZER_JOB_TARGET_COMBOS_CPU } from '@/engine/optimizer/constants'
...
// throttle ui progress updates so long runs do not spam the main thread
...
// build a reusable progress payload from processed row count and elapsed time
