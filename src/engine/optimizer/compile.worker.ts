...
} from '@/engine/optimizer/compileWorker.types'

let optimizerCompileModulesPromise: Promise<{
  compileOptimizerPayload: typeof import('@/engine/optimizer/rebuild/compiler').compileOptimizerPayload
  materializeOptimizerResultsFromUids: typeof import('@/engine/optimizer/rebuild/materialize').materializeOptimizerResultsFromUids
}> | null = null

async function loadOptimizerCompileModules() {
  if (!optimizerCompileModulesPromise) {
    optimizerCompileModulesPromise = Promise.all([
      import('@/engine/optimizer/rebuild/compiler'),
      import('@/engine/optimizer/rebuild/materialize'),
