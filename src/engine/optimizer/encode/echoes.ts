...
import { buildTeamCompositionInfo } from '@/domain/gameData/teamComposition.ts'
import { listSourceEffects, listSourceStates } from '@/domain/gameData/registry.ts'
import type { EffectEvalScope, EffectOperation } from '@/domain/gameData/contracts.ts'
import type { EchoInstance, ResonatorRuntimeState } from '@/domain/entities/runtime.ts'
import type { AttributeKey, FinalStats, ResonatorBaseStats, SkillTypeKey } from '@/domain/entities/stats.ts'
import { getEchoById } from '@/domain/services/echoCatalogService.ts'
import { evaluateCondition, evaluateFormula } from '@/engine/effects/evaluator.ts'
