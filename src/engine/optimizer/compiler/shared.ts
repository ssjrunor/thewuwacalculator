...
import type { OptimizerStartPayload } from '@/engine/optimizer/types.ts'
import { buildOptimizerCombinadicIndexing } from '@/engine/optimizer/combos/combinadic.ts'
import type { EncodedEchoRows } from '@/engine/optimizer/encode/echoes.ts'
