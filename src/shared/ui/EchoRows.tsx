...
// the loadout's totals, in the same set plan tray the rows borrow from. a
// sonata is named once here rather than on every row, and a group sitting
// under its 2pc threshold wears its underline at rest.
    ...
    <div className={`ecr-foot ${className}`.trim()}>
      ...
      <div className="ecr-foot__figs">
        <span className="ecr-foot__fig">
          ...
          {/* the loadout is graded the way the echo pane grades it, so the
              total wears the same colour on both surfaces */}
