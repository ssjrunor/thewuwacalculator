...
import { makeEvaluationCostPlans } from '@/data/scoring/evaluation/costPlans'
...
import { SET_RULES, evaluationSetConditions } from '@/data/scoring/setStatePolicy'
import {
  assembleEvaluation,
  evaluationErTarget,
  buildEvaluationAnchors,
  type EvaluationAnchors,
} from '@/data/scoring/evaluation/search.ts'
import {
  hasNonSelfMainEchoBuff,
  preservedMainEchoFor,
  utilityPlanFor,
} from '@/data/scoring/evaluation/echoDiscovery.ts'
import type { EvaluationBuildSnapshot } from '@/data/scoring/evaluation/types.ts'
