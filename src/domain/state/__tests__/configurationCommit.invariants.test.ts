...
import { consumePersist } from '@/infra/persistence/storage.ts'
...
describe('configuration commit boundaries', () => {
  ...
  it('publishes a scenario configuration as one revision and history entry', () => {
  ...
  it('publishes several appearance edits as one persisted history entry', () => {
