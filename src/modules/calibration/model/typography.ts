/*
  Author: Runor Ewhro
  Description: applies a chosen body font to the document: resolving a link,
               loading the stylesheet, and writing the CSS variables. The fonts
               themselves are listed in `@/domain/entities/appearance.ts`.
*/
