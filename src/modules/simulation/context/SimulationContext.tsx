/*
  Author: Runor Ewhro
  Description: Owns ctx behavior and state transitions for the lib module.
*/
...
import { skillTab } from '@/modules/simulation/context/skillData.ts'
...
export function SimulationProvider({
  ...
  const swtcToEnts = useMemo<MenuEntry[]>(() => {
    ...
    // resonators carry their own art, so these wells wear the sprite rather
    // than a row of near-identical portraits behind a label.
