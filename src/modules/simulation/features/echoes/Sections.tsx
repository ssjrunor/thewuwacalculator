...
function StatIcon({ statKey }: { statKey: string }) {
  ...
  return (
    <span className="echo-stat-icon-mask"
      style={{
        ...
        <div className="echo-slot-card">
          <div className="echo-slot-left">
            ...
            <div className="echo-slot-actions">
              ...
              <button
                type="button" className="echo-slot-action"
              ...
              <button
                type="button" className="echo-slot-remove"
                title="Remove echo"
                onClick={onRemove}
              >
    ...
    return (
      <div className={`echo-set-state${checked ? ' echo-set-state--active' : ''}`}>
        <label className="echo-set-state-toggle">
          ...
          <span className="echo-set-state-label"
            dangerouslySetInnerHTML={{ __html: fmtDscr(desc) }}
          />
        </label>
        {trigger ? (
          <span className="echo-set-state-trigger"
        ...
        <div className="echo-set-state-step">
          <div className="echo-set-state-step-header">
            ...
            <div className="echo-set-state-step-count">
              <input
                type="number" className="echo-set-state-step-count-input"
                value={stepValue}
                min={0}
                max={maxSteps}
                onChange={(e) => {
...
export function EchoTotals({
  ...
  const cvGrade = cmptBldCritGr(echoes)
  ...
  return (
    <Expandable className="echo-totals"
      header={
        <div className="echo-totals-header">
          ...
          <div className="echo-totals-badges">
            ...
            {totalCV > 0 ? (
              <span className={getCvBdgClss(cvGrade)}>
