...
import { clampQuickBuff, makeModId, mprtPay, cleanBuffs } from '@/modules/simulation/features/buffs/lib/helpers.ts'
import { cloneManualMods } from '@/modules/simulation/features/buffs/lib/clipboard.ts'
import {
  ADV_SKILL_MATCH,
  ADV_SKILL_TYPES,
  DEFDVNCMODSC,
...
function QbuffGlyph({ statKey }: { statKey: string }) {
  ...
  return (
    <span className="mcc-qbuff-glyph"
      aria-hidden="true"
                ...
                >
                  <div className="mcc-mod-head">
                    <button
                      type="button"
                      role="switch"
                      aria-checked={modifier.enabled} className="mcc-mod-power"
                    ...
                    <span className="mcc-mod-tools">
                      <button
                        type="button" className="mcc-mod-tool"
                      ...
                      <button
                        type="button" className="mcc-mod-tool is-remove"
