...
import {
  ...
  mprtPay,
  cleanBuffs,
} from '@/modules/simulation/features/buffs/lib/helpers.ts'
import {
  makeModClip,
  cloneMnlMdfr,
  cloneManualMods,
  readMnlModCl,
  writeMnlModC,
} from '@/modules/simulation/features/buffs/lib/clipboard.ts'
import {
  applySkillMod,
  getModVlMax,
  getModVlSfx,
  getSkllModPt,
  modSummary,
} from '@/modules/simulation/features/buffs/lib/manualBuffOps.ts'
...
export function BuffEditor({
  ...
  const menu = useOptionalSimulationContext()
  ...
  const mkModRowCtxM = useCallback((modifier: MnlMod): MenuEntry[] => {
    ...
    return menu?.builders.simulation.manualBuffs.item({
    ...
    dltMnlModSel,
    dplcMnlMdfr,
    menu?.builders.simulation.manualBuffs,
    modSel,
    pstMnlMdfr,
    resModCtnTgt,
  ])
  ...
  const mkModPaneCtx = useCallback((): MenuEntry[] => {
    ...
    return menu?.builders.simulation.manualBuffs.pane({
          ...
          header={
            <div className="manual-modifier-card-head">
              ...
              <div className="manual-modifier-actions">
                ...
                <button
                  type="button" className="block-icon-button delete"
    ...
    <>
      ...
      {showTrnsCtns ? (
        <div className="custom-buffs-footer">
          ...
          />
          <button
            type="button" className="ui-pill-button"
          ...
          <button
            type="button" className="ui-pill-button ui-pill-button-danger custom-buffs-clear"
