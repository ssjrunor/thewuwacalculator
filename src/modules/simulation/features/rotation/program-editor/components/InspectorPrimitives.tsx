/*
  Author: Runor Ewhro
  Description: Implements the InspectorPrimitives logic for the components module.
*/

import type { ReactNode } from 'react'
import { Expandable } from '@/shared/ui/Expandable.tsx'
import { withDefIconM } from '@/shared/lib/imageFallback.ts'
import type { BuffLine } from '@/modules/simulation/features/rotation/program-editor/model/program.ts'
