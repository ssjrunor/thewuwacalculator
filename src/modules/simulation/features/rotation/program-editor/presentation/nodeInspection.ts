/*
  Author: Runor Ewhro
  Description: Implements the nodeInspection logic for the presentation module.
*/
...
import { srcAssetIcon, type RunResult } from '@/modules/simulation/features/rotation/program-editor/simulation/runProgram.ts'
import type { BuffLine, EditorStep } from '@/modules/simulation/features/rotation/program-editor/model/program.ts'
import { stepHasRun } from '@/modules/simulation/features/rotation/program-editor/presentation/registerRows.ts'
