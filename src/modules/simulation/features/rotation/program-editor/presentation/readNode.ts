/*
  Author: Runor Ewhro
  Description: Owns read node behavior and state transitions for the presentation module.
*/
...
import { editorNodeLabel } from '@/modules/simulation/features/rotation/program-editor/model/program.ts'
import type { AttributeKey } from '@/domain/entities/stats.ts'
import { ATTR_COLORS } from '@/domain/gameData/attributeDisplay.ts'
import { findNode, collectSubtrees } from '@/modules/simulation/features/rotation/program-editor/model/treeEdit.ts'
...
import { loopBodyItems, stepCount, stepDamageAt, stepHasRun } from '@/modules/simulation/features/rotation/program-editor/presentation/registerRows.ts'
