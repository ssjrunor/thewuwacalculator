/*
  Author: Runor Ewhro
  Description: Owns flat rows behavior and state transitions for the presentation module.
*/
...
/** Counts the selectable execution entries painted for a shared node set. */
