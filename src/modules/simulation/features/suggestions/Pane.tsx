...
import {
  calcSubPrio,
  type SubstatEntry,
} from '@/modules/simulation/features/suggestions/surfaceAlgorithms/substatPriority.ts'
import { runRandomEchoSuggestions } from '@/modules/simulation/features/suggestions/surfaceAlgorithms/randomEchoes/client.ts'
import { makeRandomEchoCostPlans } from '@/modules/simulation/features/suggestions/surfaceAlgorithms/randomEchoes/combinations.ts'
import { prepareRandomEchoGeneration } from '@/modules/simulation/features/suggestions/surfaceAlgorithms/randomEchoes/prepare.ts'
import type { RandomEchoEntry } from '@/modules/simulation/features/suggestions/surfaceAlgorithms/randomEchoes/types.ts'
import { calcSubEvaluation, type SubstatEvaluation } from '@/data/scoring/substatEvaluation.ts'
import { SubstatPriorityTables as SubPrioTables, type SubstatViewRow } from '@/modules/simulation/features/suggestions/SubstatPriorityTables.tsx'
import type {
  MainStatSugg,
  SetPlanSuggest,
  WeaponEntry,
...
import {
  ...
  SuggToolbar,
  selectableProps,
} from '@/modules/simulation/features/suggestions/Parts.tsx'
import { WpnCfgMdl } from '@/modules/simulation/features/suggestions/WeaponConfig.tsx'
import { WeaponInspect } from '@/modules/simulation/features/suggestions/WeaponInspect.tsx'
import {
  targetOpts,
  targetGroups,
  type SuggTgtPtn,
