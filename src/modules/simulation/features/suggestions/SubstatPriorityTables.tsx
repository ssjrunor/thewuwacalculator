...
import type { SubstatEntry } from '@/modules/simulation/features/suggestions/surfaceAlgorithms/substatPriority.ts'
import type { SubstatEvaluation, SubstatEvaluationRow } from '@/data/scoring/substatEvaluation.ts'
