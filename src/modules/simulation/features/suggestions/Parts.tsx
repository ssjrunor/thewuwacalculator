/*
  Author: Runor Ewhro
  Description: Owns parts behavior and state transitions for the suggestions module.
*/
...
import { getDiffLabel, getDiffTone } from '@/modules/simulation/features/suggestions/lib/suggestions.ts'
