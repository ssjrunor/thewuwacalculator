/*
  Author: Runor Ewhro
  Description: The optimizer body mounted inside the shared Build Lab board.
               The shared surface owns the roster and rail while the score band
               remains canonical and the Echo strip is a disposable workspace
               seeded by the selected result.
               Once results are on the board the band retracts, because the
               rail's grade plate already carries that reading and the rows
               want the height more than the gauge does.
*/

import type { ReactNode, Ref } from 'react'
import { useShallow } from 'zustand/react/shallow'
import { useAppStore } from '@/domain/state/store'
import { selVrvwDrvd } from '@/domain/state/selectors'
...
import { EvaluationBand } from '@/modules/simulation/modulation/EvaluationBand.tsx'
...
import { OptimizerEchoPreview } from '@/modules/simulation/features/optimizer/transport/OptimizerEchoPreview.tsx'
