...
import type { EvaluationBuildSnapshot, EvaluationEchoSlot, BuildEvaluationReport } from '@/data/scoring/buildEvaluation.ts'
...
import { CtnSqnc } from '@/modules/simulation/modulation/ActionSequence.tsx'
import { SeatStack } from '@/modules/simulation/modulation/SeatStack.tsx'
import { mkSqnc } from '@/modules/simulation/modulation/lib/rotationSequence.ts'
import { makeConditionChoices, visibleRotMembers } from '@/modules/simulation/features/rotation/shared/catalog.ts'
import {
  BUILD_LABEL,
  DETAIL_BUILD_LABEL,
  DETAIL_BUILD_ORDER,
...
export function ModulationReport({
  ...
  modulationScenario: CombatScenario | null
  ...
  return (
    <>
      ...
      {modulation ? (
        modulationRuntime && modulationActRt && modulationScenario ? (
          <ModulationView
            runtime={modulationRuntime}
            actRt={modulationActRt}
            scenario={modulationScenario}
