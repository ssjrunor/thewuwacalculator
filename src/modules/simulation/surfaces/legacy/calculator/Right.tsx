/*
  Author: Runor Ewhro
  Description: Hosts legacy calculator output panes derived from canonical Simulation preparation.
*/
...
import { getNegFfctFf, negEffectsFor } from '@/engine/gameData/negativeEffects'
import type { SimResult } from '@/engine/pipeline/types'
import {
  makeStatsView,
  formatCompactNum,
} from '@/modules/simulation/model/statsView.ts'
import { getPrimarySkill } from '@/domain/gameData/skillTypes'
