/*
  Author: Runor Ewhro
  Description: Hosts the legacy calculator input panes against canonical Simulation state adapters.
*/
...
const LazyCalcSugg = lazy(async () => ({
  default: (await import('@/modules/simulation/surfaces/suggestions/Pane.tsx')).Suggestions,
}))
