    ...
    <div className="co">
      <div className="co-split">
        <div className="co-portrait">
          <button
            type="button" className="co-portrait__ring co-portrait__ring-button"
        ...
        <div className="co-config">
          <div className="co-skill-bar">
            <LiquidSelect
              ...
              renderTrigger={(selPtn, placeholder) => (
                <>
                ...
                <>
                  <div className="co-field co-field--weapon">
                    <div className="co-tile__head">
                      ...
                      <button
                        type="button" className="co-button"
            ...
            <section className="co-tile">
              ...
              {optRuntime ? (
                <div className="co-qbuff">
                    ...
                    {(
                      ...
                      <div key={stat} className="co-qbuff-row">
                        ...
                        <div className="co-qbuff-inputs">
                          <NumberInput className="co-qbuff-in"
                            min={-9999}
                            max={9999}
                  ...
                  <button
                    type="button" className="co-qbuff-adv-btn"
