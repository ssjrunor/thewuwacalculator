/*
  Author: Runor Ewhro
  Description: Aggregates node damage, execution counts, shares, and loop-normalized totals.
*/
...
import { isNodeEffectivelyDisabled } from '@/modules/simulation/surfaces/rotation/program-editor/model/treeEdit.ts'
import { selectedRunForNode } from '@/modules/simulation/surfaces/rotation/program-editor/model/executionScope.ts'
