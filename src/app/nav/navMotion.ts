/*
  Author: Runor Ewhro
  Description: Whether a page change is allowed to be animated at all. The move
               itself has no direction and no variants, so this is the whole of
               what script decides about it; the rest is drawn by the
               stylesheet, save for the one move it draws differently.
*/
