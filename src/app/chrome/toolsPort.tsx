/*
  Author: Runor Ewhro
  Description: One node the head keeps open for the page standing under it. A
               route with controls of its own puts them here instead of drawing
               a bar of its own above the page, and the chrome never has to know
               that route exists. React context reaches through a portal, so the
               controls are still written where their state lives.
*/
