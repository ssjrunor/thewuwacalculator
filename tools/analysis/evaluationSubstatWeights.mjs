...
async function run(options) {
  ...
  try {
    const [
      ...
      loader.load('/src/engine/evaluation/evaluation/costPlans.ts'),
      ...
      loader.load('/src/engine/evaluation/substatMath.ts'),
      loader.load('/src/engine/evaluation/evaluation/stats.ts'),
      loader.load('/src/engine/evaluation/evaluation/search.ts'),
      loader.load('/src/engine/evaluation/evaluation/echoDiscovery.ts'),
      loader.load('/src/modules/simulation/model/evaluationAssumptions.ts'),
      loader.load('/src/engine/evaluation/setStatePolicy.ts'),
